// sourced from https://medium.com/@TomazZaman/how-to-get-fast-unit-tests-with-out-webpack-793c408a076f#.8yqwke54s
// This does some strange things, but is super fast, so let's give it a try
...
function runSuite() {
  ...
  const mocha = new Mocha({ reporter: 'dot', ui: 'bdd-lazy-var' });
...
chokidar.watch('app/**/*.js', { persistent: true })
  .on('change', path => runSuite());
